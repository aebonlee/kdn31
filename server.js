...
app.post('/api/config', (req, res) => {
  ...
  if (defacementType !== undefined) {
    const validTypes = ['none', 'hacked', 'hacktivist', 'ransomware', 'phishing', 'seo-spam', 'crypto-mining', 'refersec', 'malware-download', 'webshell', 'redirect', 'darkleaks', 'subtle-deface'];
